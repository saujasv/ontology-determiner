module.exports =  function (graph) {
    ...
    loadingModule.parseUrlAndLoadOntology=function() {
        console.log("Loading module stuff :")
        ...
        ontologyContent = d3.select("#OntologyContentSource").node().value ;
        // console.log("works3") 
        // console.log("ontologyContent :", ontologyContent) ;
        // console.log("json ontoC :", ontoC) ; 
        // ontoC = JSON.parse(ontoC) ;
        console.log("works1")
        d3.select("#progressBarValue").node().innerHTML=" ";
        console.log("works2")
        ontoC = document.getElementById("OntologyContentSource").innerHTML ; 
        console.log("ontoC : ", ontoC) ; 
        parseOntologyContent(ontoC)
    ...
    loadingModule.from_JSON_URL=function(fileName){
        ...
        if (ontologyMenu.cachedOntology(filename)) {
            ...
            // need to get ontologyContent = {jsonreturneds}
    ...
    loadingModule.from_FileUpload=function(fileName){
        console.log("Inside file update") ; 
        loadingModule.setBusyMode();
        ...
        if (ontologyMenu.cachedOntology(filename)) {
            ...
            console.log("Retrieving ontology from file")  ;
            ...
            console.log("filename to be retrieved : ", filename) ;
...
//1] Direct Json Upload
            if (filename.match(/\.json$/)) {
                ...
                console.log("File to be read as text-->", selectedFile)
                reader.readAsText(selectedFile);
                reader.onload = function () {
                    ontologyContent=reader.result;
                    ontologyIdentifierFromURL=filename;
                    console.log("ontology content :", ontologyContent);
                    console.log("ontology identifier :", ontologyIdentifierFromURL) ;
                    parseOntologyContent(ontologyContent);
                };
            }else{
//2] File Upload to OWL2VOWL Converter
    ...
    function parseOntologyContent(content){
        console.log("Inside parse onto function");
