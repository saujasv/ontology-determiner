...
module.exports = function (graph) {
	...
	function displayPropertyInformation(property) {
		...
		// console.log(property.labelForCurrentLanguage()) ; 
		// console.log(property.label()) ;
		// console.log(property.labelElement()) ;  
		// console.log(property.subproperties()) ;
		// console.log(property.superproperties()) ;
		// console.log(property.domain().label()["IRI-based"]) ; 
		// console.log(property.range().label()["IRI-based"]) ; 
		// console.log(property.domain().label()) ; 
		// console.log(property.range().label()) ; 
		// console.log(property.domain().iri()) ; 
		// console.log(property.range().iri()) ; 
